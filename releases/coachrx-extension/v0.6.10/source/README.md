...
Version actuelle: `0.6.10`. L'extension a une icone CFSB/Rx distincte pour eviter de la confondre avec les autres extensions Chrome.
...
le `localStorage`. La version 0.6.10 utilise ce jeton uniquement dans la page pour
