...
Version actuelle: `0.6.3`. L'extension a une icone CFSB/Rx distincte pour eviter de la confondre avec les autres extensions Chrome.
Cette version renforce la lecture de la page visible pour eviter que des boutons comme `Edit Profile` soient importes comme clients.
...
2. Aller dans la vue `Clients` du coach vise.
