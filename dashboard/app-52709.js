...
function questionnaireFilters(responses, staleClients, sentNoResponse, relanceDue, sendErrors, clients) {
  ...
  return `
    ...
    <p class="filter-help">Les couleurs rouge, orange, jaune et vert servent a prioriser les cartes. Elles ne sont plus des filtres principaux pour garder l'outil simple.</p>
