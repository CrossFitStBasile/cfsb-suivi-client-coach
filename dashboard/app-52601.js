  ...
  els.content.innerHTML = `
    <section class="mission-panel performance-hero">
      ...
      <div class="priority-strip">
        ...
        ${priorityTile("A valider", allRows.filter((row) => !row.date).length, "p1")}
      </div>
    </section>
    <section class="mission-panel performance-hero">
  ...
  return `
    <article class="compact-row rebooking-row">
      ...
      <div class="row-actions compact-actions">
        <button class="pending-action" disabled>Rappel client a brancher</button>
...
function questionnaireSendButtonLabel() {
  return state.isDemo ? "Simuler questionnaire" : "Envoi en pause";
}
