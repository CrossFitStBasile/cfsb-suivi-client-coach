...
function operationalModules() {
  ...
  return [
    ...
    },
    {
      ...
      tone: "good",
      description: "Source utile pour les seances a remettre. Chaque coach peut ouvrir sa file rebooking securisee; le dashboard garde les taches et le contexte.",
      links: [
        ["Ouvrir le suivi rebooking", "https://docs.google.com/spreadsheets/d/1s7shtrkL0gs1DO0LbzkbabZteidGnYLhVou6KliHXVU/edit"]
      ].concat(activeRebookingUrl ? [["Ouvrir mon rebooking", activeRebookingUrl]] : [])
    },
    {
