...
document.addEventListener("click", (event) => {
  ...
  if (sendQuestionnaireButton) {
    sendQuestionnaire(sendQuestionnaireButton.dataset.clientKey || "");
  }
...
function demoSetTaskStatus(taskId, status) {
  ...
  }, status === "Fait" ? "Tache demo completee." : "Statut demo enregistre.");
}
...
function demoSendQuestionnaire(client) {
  mutateDemoData((data) => {
...
async function sendQuestionnaire(clientKey, clientName) {
