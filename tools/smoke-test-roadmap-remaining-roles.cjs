...
const roles = [
  {
    ...
    checks: ["Cadre du role Head Coach", "Programmation, standards et intention technique", "Observation, feedback et developpement des coachs"],
    scores: [
  ...
  },
  {
    ...
    checks: ["J'organise les evenements avec calendrier", "Je mets regulierement en valeur les progres", "Je mesure l'impact des evenements"],
    scores: [
      "event_planning_structure_score",
      "event_online_presence_score",
      "event_innovation_score",
